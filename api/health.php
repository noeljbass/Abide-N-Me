...
$requiredTables = ['users', 'user_settings', 'auth_sessions', 'rate_limits', 'groups', 'group_members', 'group_invites', 'canons', 'books', 'canon_books', 'translations'];
...
try {
    ...
    JsonResponse::success([
        'database' => 'connected',
        'schema' => 'ready',
        'server' => str_contains(strtolower($version), 'mariadb') ? 'MariaDB' : 'MySQL',
        'sessions' => \FeedMySheep\Session::storageStatus(),
    ]);
