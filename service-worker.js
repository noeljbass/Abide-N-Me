const CACHE_NAME = 'feed-my-sheep-shell-v21';
const APP_SHELL = [
  ...
  './assets/js/native.js', './assets/js/pwa.js', './assets/js/auth.js', './assets/js/api.js', './assets/js/groups.js', './assets/js/bible.js', './assets/js/plans.js', './assets/js/today.js', './assets/js/audio.js', './assets/js/audio-state.js'
];
